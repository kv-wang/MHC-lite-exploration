#!/usr/bin/env bash
#
# Train 4-stream mHC models from scratch with L2 ADMM H_res projection.
# Runs small, medium, then large model configurations.
#
# Usage:
#   ./run_admm_l2.sh
#   N_GPUS=1 MAX_ITERS=100 ./run_admm_l2.sh
...
METHOD_CONFIG="${METHOD_CONFIG:-config/with_mhc_admm_l2.py}"
...
echo ""
echo "================================================================"
echo " Running 4-stream mHC ADMM-L2 training for small/medium/large"
...
run_model() {
  ...
  local wandb_run_name="${model_name}-mhc-admm-l2-4streams-${MAX_ITERS}iter"
  local wandb_project="${WANDB_PROJECT_PREFIX}_${model_name}"
  local out_prefix_method="mhc-admm-l2-4streams-${MAX_ITERS}iter"

  echo ""
  echo "================================================================"
  echo " Running ${model_name} mHC ADMM-L2"
...
echo ""
echo "================================================================"
echo " 4-stream mHC ADMM-L2 small/medium/large training completed"
echo "================================================================"
