#!/usr/bin/env bash
#
# Train 4-stream mHC with S-prox-ALM H_res constraints:
#   row sums = 1 and column sums = 1. Entries are allowed to be negative.
# Mirrors run_mhc_alm_nonnegative.sh.
#
# Usage:
#   ./run_mhc_alm_signed_sprox.sh
#   N_GPUS=1 MAX_ITERS=100 ./run_mhc_alm_signed_sprox.sh
...
METHOD_CONFIG="${METHOD_CONFIG:-config/with_mhc_alm_signed_sprox.py}"
...
echo ""
echo "================================================================"
echo " Running 4-stream mHC ALM-signed-S-prox training for small/medium/large"
...
run_model() {
  ...
  local wandb_run_name="mhc-${model_name}-mhc-alm-signed-sprox-4streams-${MAX_ITERS}iter"
  local wandb_project="${WANDB_PROJECT_PREFIX}_${model_name}"
  local out_prefix_method="mhc-alm-signed-sprox-4streams-${MAX_ITERS}iter"

  echo ""
  echo "================================================================"
  echo " Running ${model_name} mHC ALM-signed-S-prox"
...
echo ""
echo "================================================================"
echo " 4-stream mHC ALM-signed-S-prox small/medium/large training completed"
echo "================================================================"
