#!/usr/bin/env bash
#
# Train 4-stream mHC models from scratch with reverse-KL S-prox-ALM H_res projection.
# Runs small, then medium model configurations.
#
# Usage:
#   ./run_admm_reverse_kl_sprox_alm.sh
#   N_GPUS=1 MAX_ITERS=100 ./run_admm_reverse_kl_sprox_alm.sh
...
METHOD_CONFIG="${METHOD_CONFIG:-config/with_mhc_admm_reverse_kl_sprox_alm.py}"
...
echo ""
echo "================================================================"
echo " Running 4-stream mHC reverse-KL S-prox-ALM training for small/medium"
...
run_model() {
  ...
  local wandb_run_name="mhc-${model_name}-mhc-admm-reverse-kl-sprox-alm-4streams-${MAX_ITERS}iter"
  local wandb_project="${WANDB_PROJECT_PREFIX}_${model_name}"
  local out_prefix_method="mhc-admm-reverse-kl-sprox-alm-4streams-${MAX_ITERS}iter"

  echo ""
  echo "================================================================"
  echo " Running ${model_name} mHC reverse-KL S-prox-ALM"
...
echo ""
echo "================================================================"
echo " 4-stream mHC reverse-KL S-prox-ALM small/medium training completed"
echo "================================================================"
