#!/usr/bin/env bash
#
# Train baseline GPT models without mHC / HC / mHC-lite.
#
# Usage:
#   ./run_no_mhc.sh
#   N_GPUS=1 MAX_ITERS=100 ./run_no_mhc.sh
...
echo ""
echo "================================================================"
echo " Running no-mHC baseline training for small/medium/large"
...
run_model() {
  ...
  local wandb_run_name="no-mhc-${model_name}-${MAX_ITERS}iter"
  local wandb_project="${WANDB_PROJECT_PREFIX}_${model_name}"
  local out_prefix_method="no-mhc-${MAX_ITERS}iter"

  echo ""
  echo "================================================================"
  echo " Running ${model_name} no-mHC baseline"
...
echo ""
echo "================================================================"
echo " no-mHC baseline small/medium/large training completed"
echo "================================================================"
