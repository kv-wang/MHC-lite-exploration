#!/usr/bin/env bash
#
# Train medium model with ordinary 4-stream mHC.
#
# Usage:
#   ./run_mhc_medium.sh
#   N_GPUS=1 MAX_ITERS=100 ./run_mhc_medium.sh
...
echo ""
echo "================================================================"
echo " Running medium ordinary mHC training"
...
echo ""
echo "================================================================"
echo " medium ordinary mHC training completed"
echo "================================================================"
